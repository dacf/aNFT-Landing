    ...
    return (
		<main className="mt-10 mx-auto max-w-screen-xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 xl:mt-28">
			<div className="text-center">
				...
				<h1 className="text-2xl tracking-tight leading-6 font-extrabold text-pink-cyber whitespace-nowrap sm:text-5xl sm:leading-none md:text-6xl">
					Autonomous NFT's
				</h1>
				<h1 className="text-2xl tracking-tight leading-6 font-extrabold text-blue-cyber whitespace-nowrap sm:text-5xl sm:leading-none md:text-6xl">
					A new form of Life
				</h1>
				...
				<div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-4 hidden">
					...
					text-white bg-=pflb-odlf-0kl9fdb8uj0 hover:bg-blue-500 focus:outline-none focus:border-blue-700 focus:shadow-outline-indigo transition 
				...
				<div className="pt-4 sm:pt-20 text-center">
					...
					<span>
						...
						<Link my={{base: 2, md: 1}} mx={{base: 1, md: 2}} aria-label="ProtocolLabs" rel="noreferrer" target="_blank" href="">
							<img className="content-center h-12 mr-4 ml-4" src="autonomylogo2.png"/>
						</Link>
						<Link my={{base: 2, md: 1}} mx={{base: 1, md: 2}} aria-label="ProtocolLabs" rel="noreferrer" target="_blank" href="">
